...
from typing import Any, Iterable, List, Set, TextIO, Optional

from .stubs import generate_stubs as generate_stubs_
...
def create_cpp_module(
    ...
    format_command: :class:`str`
        Passed onto :func:`generate_stubs`
